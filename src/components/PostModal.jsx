                    ...
                    <Content>
                        <Header>
                            ...
                            <button onClick={(event) => reset(event)}>
                                <img width="20px" src="/images/close_icon.png" alt="" />
                            </button>
                        </Header>
                        <SharedContent>
                            <UserInfo>
                        ...
                        <SharedCreation>
                            <AttachAssets>
                                <AssetButton onClick={() => switchAssetArea("image")}>
                                    <img width="22px" src="/images/share-image.png" alt="" />
                                </AssetButton>
                                <AssetButton onClick = {() => switchAssetArea("media")}>
                                    <img width="25px" src="/images/share-video.png" alt="" />
                                </AssetButton>
                            </AttachAssets>
                            <ShareComment>
                                <AssetButton>
                                    <img width="12px" src="/images/share-commentt.png" alt="" />
                                    Anyone
                                </AssetButton>
                            </ShareComment>
                            <PostButton 
...
const PostButton = styled.button`
    ...
    background: ${(props) => (props.disabled? "rgba(1,1,1,0.8)" : "#0a66c2")};
    &:hover {
